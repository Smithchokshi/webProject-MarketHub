...
const AddProduct = () => {
  ...
  <GlobalHeader title={'Add Product'} />
  <Content>
    <div className="login-page">
      <div className="login-box">
        ...
        <Form className="login-form" name="login-form" initialValues={{ remember: true }} layout="vertical">
          ...
          <div style={{ display: 'flex', justifyContent: 'center', fontSize:'15px', fontfamily: 'Josefin Sans, sans-serif', fontWeight:'bold'}}>
          ...
          <Form.Item>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontfamily: 'Josefin Sans, sans-serif' }}>
              <div>
